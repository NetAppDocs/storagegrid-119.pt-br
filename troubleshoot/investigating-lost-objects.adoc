...
summary: Quando o alerta de objetos perdidos for acionado, você deve investigar imediatamente. Colete informações sobre os objetos afetados e entre em contato com o suporte técnico. 
---
