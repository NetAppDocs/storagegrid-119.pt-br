...
summary: O alerta de baixo espaço de armazenamento de dados de objetos monitora quanto espaço está disponível para armazenar dados de objetos em cada nó de armazenamento. 
---
